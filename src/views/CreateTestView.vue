          ...
          <template #slotBody>
            <div class="flex flex-wrap gap-6 justify-center">
              <InputIdentifyUser
                ...
                <template #slotHeader>
                  <ButtonRemove
                    @click.prevent="removeIdQuestion(qInx)"></ButtonRemove>
                </template>
              ...
              <ButtonAdd
                ...
                @click.prevent="addIdQuestion"></ButtonAdd>
            </div>
          </template>
        </AppQuestionTemplate>
        <AppQuestionTemplate
                  ...
                  <li
                    ...
                    <div class="w-full text-md gap-2 px-4 flex justify-end p-2">
                      ...
                      <div class="flex ml-4">
                        <ButtonMark
                          :isTrue="is_true"
                          @click.prevent="markAnswer(qInx, aInx)"></ButtonMark>
                        <ButtonRemove
                          @click.prevent="
                            removeAnswer(qInx, aInx)
                          "></ButtonRemove>
                      </div>
                    </div>
                    <textarea
